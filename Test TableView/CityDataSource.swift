...
class CityDataSource: NSObject, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "MyTableCell-Id", for: indexPath) as! MyTableViewCell
        ...
        cell.cityLabel.font = .preferredFont(forTextStyle: .largeTitle)
        cell.stateLabel.font = .preferredFont(forTextStyle: .largeTitle)
        
        cell.cityLabel.text = item.components(separatedBy: ", ")[0]
        cell.stateLabel.text = item.components(separatedBy: ", ")[1]
